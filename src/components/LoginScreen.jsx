...
export const LoginScreen = () => {
  ...
  return (
    <div className="login-screen" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px 14px' }}>
        <div className="login-card">
          ...
          <div className="login-sub">Al Jamea Tus Saifiyah — Marol Campus</div>
      ...
      {/* SLEEK MASKAN1447 & LAHERI72 FOOTER */}
      <Footer />
    </div>
  );
};
